<template>
    <div class="creatingPlan">
        <div class="operation-btn">
            <el-button type="success" icon="el-icon-plus" @click="dialogFormEntrance = true">新建单位</el-button>
            <el-input
        ...
        >
            <el-table-column label="单位全称" width="120">
                <template slot-scope="scope">{{ scope.row.date }}</template>
            </el-table-column>
            <el-table-column prop="name" label="简称" width="120"></el-table-column>
            <el-table-column prop="name" label="地址" width="120"></el-table-column>
            <el-table-column prop="name" label="邮政编码" width="120"></el-table-column>
            <el-table-column prop="name" label="联系人"></el-table-column>
            <el-table-column prop="name" label="电话号码"></el-table-column>
            <el-table-column prop="name" label="区属"></el-table-column>
            <el-table-column prop="name" label="上级单位"></el-table-column>
        </el-table>
        <el-dialog title="创建单位" :visible.sync="dialogFormEntrance" width="37%">
            <el-form :model="form" style="padding: 0 40px 0 10px">
                ...
                <el-form-item label="区属" :label-width="formLabelWidth">
