<template>
    <div class="curing">
        <div class="operation-btn">
            <el-button type="success" icon="el-icon-plus" @click="dialogFormWorks = true">生成任务</el-button>
        ...
        >
            ...
            <el-table-column prop="address" label="任务详情" show-overflow-tooltip></el-table-column>
