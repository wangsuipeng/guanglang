<template>
    <div class="curing">
        <div class="operation-btn">
            <el-button type="success" icon="el-icon-plus" @click="dialogFormWorks = true">新增其他计划</el-button>
            <el-button type="warning" icon="el-icon-edit" @click="dialogFormWorks = true">修改其他计划</el-button>
            <el-button type="danger" icon="el-icon-delete" @click="dialogFormWorks = true">删除其他计划</el-button>
        ...
        >
            ...
            <el-table-column prop="name" label="管廊名称称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="计划详" width="120"></el-table-column>
            <el-table-column prop="address" label="计划名细" show-overflow-tooltip></el-table-column>
