<template>
    <div class="curing">
        <div class="operation-btn">
            <el-button type="primary" icon="el-icon-plus" @click="dialogFormWorks = true">新增养护计划</el-button>
        ...
        >
            ...
            <el-table-column prop="name" label="管廊名称" width="120"></el-table-column>
            <el-table-column prop="address" label="计划名称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="计划详细" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="计划状态" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="计划周期" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="执行时间" show-overflow-tooltip></el-table-column>
