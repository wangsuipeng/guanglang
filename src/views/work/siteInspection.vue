<template>
    <div class="siteInspection">
        <div class="operation-btn">
            <el-button type="primary" icon="el-icon-plus" @click="dialogFormWorks = true">新增巡检计划</el-button>
            <el-button type="primary" icon="el-icon-edit" @click="dialogFormWorks = true">修改巡检计划</el-button>
            <el-button type="primary" icon="el-icon-delete" @click="dialogFormWorks = true">删除巡检计划</el-button>
            <el-button type="primary" icon="el-icon-view" @click="dialogFormWorks = true">操作</el-button>
            <el-input
        ...
        >
            ...
            <el-table-column prop="address" label="工程类型" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="管线类型" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="所属管廊" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="所有位置" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="道路范围" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="长度" show-overflow-tooltip></el-table-column>
            <el-table-column prop="address" label="宽度" show-overflow-tooltip></el-table-column>
