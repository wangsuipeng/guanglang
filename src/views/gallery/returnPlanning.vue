<template>
    <div>
        <div class="operation-btn">
            <el-button type="primary" icon="el-icon-view" @click="dialogFormReturn = true">提交申报计划</el-button>
            <el-input
        ...
        <el-dialog title="新增管廊计划" :visible.sync="dialogFormReturn" width="37%">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogFormReturn = false">取 消</el-button>
                <el-button type="primary" @click="dialogFormReturn = false">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
export default {
    data() {
        return {
            activeName: "",
            searchValue: "",
            dialogFormReturn: false, // 控制退回模态框
            form: {
                name: "",
                region: "",
                date1: "",
