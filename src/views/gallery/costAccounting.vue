<template>
    <div>
        <div class="operation-btn">
            <span>选择月份：<el-date-picker
      v-model="timeValue"
      type="date"
      placeholder="选择日期">
    </el-date-picker></span>
            <el-button style="background: #CE93D8;color: #fff;" icon="el-icon-view" @click="dialogFormRelease = true">费用核算</el-button>
            <el-input
        ...
        <el-dialog title="新增管廊计划" :visible.sync="dialogFormRelease" width="37%">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogFormRelease = false">取 消</el-button>
                <el-button type="primary" @click="dialogFormRelease = false">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
...
export default {
    data() {
        return {
            timeValue: "",
            dialogFormRelease: false, // 控制发布模态框
            activeName: "",
            searchValue: "",
            form: {
                name: "",
