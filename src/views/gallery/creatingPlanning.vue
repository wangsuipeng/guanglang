<template>
    <div class="creatingPlan">
        <div class="operation-btn">
            <el-button type="success" icon="el-icon-plus" @click="dialogFormEntrance = true">新增管廊计划</el-button>
            <el-button type="primary" icon="el-icon-view">提交申报计划</el-button>
            <el-input
        ...
        <el-dialog title="新增管廊计划" :visible.sync="dialogFormEntrance" width="37%">
